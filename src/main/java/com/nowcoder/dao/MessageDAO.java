...
public interface MessageDAO {
    ...
    @Select({"select ", SELECT_FILEDS, "from", TABLE_NAME, "where conversation_id = #{conversationId} order by create_date desc limit #{offset},#{limit}"})
//orderby都是对字段操作，limit：开始，个数。中间有逗号
